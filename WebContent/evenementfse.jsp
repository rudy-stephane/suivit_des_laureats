				...
				<li class="span3">
					...
					<li class="span3">
						<div class="thumbnail">
							<div class="blockDtl">
							<h4>My web solutions</h4>
							<a href="comingsoon.jsp"><img src="themes/images/portfolio/4.jpg" alt="bootstrap business templates"></a>
							<p>Our aim is simple - to provide affordable web design and development services for different devices. </p>
							<div class="btn-toolbar">
							   <div class="btn-group toolTipgroup">
								<a class="btn" href="#" data-placement="right" data-original-title="send email"><i class="icon-envelope"></i></a>
						...
						<div class="thumbnail">
							<div class="blockDtl">
							<h4>My web solutions</h4>
							<a href="comingsoon.jsp"><img src="themes/images/portfolio/5.jpg" alt="bootstrap business templates"></a>
							<p>Our aim is simple - to provide affordable web design and development services for different devices. </p>
							<div class="btn-toolbar">
							   <div class="btn-group toolTipgroup">
								<a class="btn" href="#" data-placement="right" data-original-title="send email"><i class="icon-envelope"></i></a>
